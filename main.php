            ...
            <div class="col-sm-12 col-md-6 col-lg-5 mx-auto">
                <div class="card card-signin my-5">
                    <div class="card-body">
                        ...
                        <form class="form-signin" action="/QUIZ/partials/_handleLogin.php" method="post">
            ...
            <div class="col-sm-12 col-md-6 col-lg-5 mx-auto">
                <div class="card card-signin my-5">
                    <div class="card-body">
                        ...
                        <form class="form-signin" action="/QUIZ/partials/_handleSignup.php" method="post">
                            <div class="form-label-group">
                            ...
                            <div class="form-label-group">
                                <input type="password" id="inputPassword" name="inputPassword"
                                    action="/forum/partials/_handleLogin.php" method="post" class="form-control"
                                    placeholder="Password" required>
