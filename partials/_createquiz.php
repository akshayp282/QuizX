   ...
   // echo $row['cid'];
    ...
    if($numRows > 0){
        ...
        $result = mysqli_query($conn, $sql);
            if($result){
                $showAlert = true;
                header("Location: /QUIZ/partials/_addqsns.php?quizcreated=true&role=$role&qtotal=$qtotal&eid=$id");
                exit();
            }
    }
    header("Location: /QUIZ/partials/_createquiz.php?quizcreated=false&role=$role&error=$showError&subject=$cname");
    }
        ...
        <div class="col-sm-12 col-md-6 col-lg-5 mx-auto">
            <div class="card card-signin my-5">
                <div class="card-body">
                    ...
                    <form class="form-signin" action="/QUIZ/partials/_createquiz.php" method="post">
