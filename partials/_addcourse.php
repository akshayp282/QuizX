        ...
        <div class="col-sm-12 col-md-6 col-lg-5 mx-auto">
            <div class="card card-signin my-5">
                <div class="card-body">
                    ...
                    <form class="form-signin" action="/QUIZ/partials/_handleCourse.php?op=add" method="post">
                        <div class="form-label-group mb-2">
                            <input type="text" id="cname" name="cname" class="form-control" placeholder="course name"
                                required autofocus>
                            <label for="cname">Course Name</label>
                        </div>
                        <button class="btn btn-lg btn-success btn-block text-uppercase" type="submit">Add
                        </button>
                    </form>
                </div>
            </div>
